  ...
  return (
    <>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(220px, 1fr))', gap: 14, marginBottom: 20 }}>
        <div style={{ padding: '16px', background: 'rgba(56, 189, 248, 0.08)', border: '1px solid rgba(56, 189, 248, 0.25)', borderRadius: 10 }}>
          <span style={{ fontSize: 11, color: 'var(--text-muted)', textTransform: 'uppercase' }}>On-Chain Base (Circle Faucet)</span>
          <p style={{ margin: '4px 0 2px', fontSize: 20, fontWeight: 700, color: 'var(--accent-cyan)' }}>20.00 USDC</p>
          <span style={{ fontSize: 11, color: '#86efac' }}>✓ Verified in MetaMask</span>
        </div>

        <div style={{ padding: '16px', background: 'rgba(34, 197, 94, 0.08)', border: '1px solid rgba(34, 197, 94, 0.25)', borderRadius: 10 }}>
          <span style={{ fontSize: 11, color: 'var(--text-muted)', textTransform: 'uppercase' }}>Total Milestone Settlements</span>
          <p style={{ margin: '4px 0 2px', fontSize: 20, fontWeight: 700, color: '#86efac' }}>+${totalSettledUsdc.toLocaleString()} USDC</p>
          <span style={{ fontSize: 11, color: 'var(--text-muted)' }}>{data.payments?.length || 0} Releases Authorized</span>
        </div>

        <div style={{ padding: '16px', background: 'rgba(234, 179, 8, 0.08)', border: '1px solid rgba(234, 179, 8, 0.25)', borderRadius: 10 }}>
      ...
      <div style={{ padding: '14px 18px', background: 'rgba(0,0,0,0.3)', borderRadius: 10, border: '1px solid rgba(255,255,255,0.08)', marginBottom: 20 }}>
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', flexWrap: 'wrap', gap: 10, marginBottom: 10 }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
            ...
            <strong style={{ fontSize: 13, color: '#e0f2fe' }}>Verified PolygonScan Proof Hub (Chain ID 80002)</strong>
          </div>
        ...
        <div style={{ display: 'flex', gap: 16, flexWrap: 'wrap', fontSize: 12 }}>
          <a
            ...
            target="_blank"
            rel="noreferrer"
            style={{ color: 'var(--accent-cyan)', textDecoration: 'underline', display: 'flex', alignItems: 'center', gap: 4 }}
          >
          ...
          <a
            ...
            target="_blank"
            rel="noreferrer"
            style={{ color: '#86efac', textDecoration: 'underline', display: 'flex', alignItems: 'center', gap: 4 }}
          >
